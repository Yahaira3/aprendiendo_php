...
<body class="bg-white">
    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand text-primary" href="#"><i class="fab fa-angellist nombre"></i> Divas</a>
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <a href='nuevas_publicaciones.php' class='btn btn-primary'><i class='fas fa-plus mr-1'></i> Crear publicación</a>
        </div>
    </div>
            ...
            if (count($listadopublicaciones) > 0) {
                foreach ($listadopublicaciones as $publicacion) { 
                    ...
                    echo "<div class='col-md-4 mb-3'>
                            <div class='card'>
                            <img class='card-img' src='recursos/archivos/{$publicacion['nombre_archivo']}' alt='hey'>
                                <div class='card-body'>
